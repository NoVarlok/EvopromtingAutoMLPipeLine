...
# from seeds.WineQT.mlp import main
# from seeds.WineQT.mlp_skip_connections import main
from seeds.WineQT.mlp_dropout import main


def prepare_data_tensor(csv_path, target_name, batch_size):
    train = pd.read_csv(csv_path)
    train_target = torch.tensor(train[target_name].values.astype(np.int64))
...
if __name__ == '__main__':
    ...
    target_name = 'quality'
    train_csv_path = '/home/lyakhtin/repos/hse/krylov2/PrepareDatasets/prepared_datasets/WineQT/train.csv'
    test_csv_path = '/home/lyakhtin/repos/hse/krylov2/PrepareDatasets/prepared_datasets/WineQT/test.csv'
